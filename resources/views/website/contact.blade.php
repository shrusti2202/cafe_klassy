    ...
    <div class="container">
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <form action="{{url('/insert_contact')}}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            <button class="btn btn-primary rounded-pill py-3 px-5" name='submit' value="Submit" type="submit">Send Message</button>
                        </div>
                    </div>
                </form>
            </div>

...
<form action="{{url('/insert_signup')}}" enctype="multipart/form-data" method="post" class='pt-3' style="border:1px solid #ccc">
@csrf
 
<div class="container">
    <label ><b>Name</b></label>
    <input type="text" placeholder="Enter Name"  name="name" value="{{old('name')}}" placeholder="Name">
    @error('name')
    ...
    <input type="text" placeholder="Enter Phone" name="mobile" value="{{old('mobile')}}" >
